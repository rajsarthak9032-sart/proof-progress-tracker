...
// 2. RevenueCat Constants & Entitlement Check Verification
const { REVENUECAT_ENTITLEMENT_ID, REVENUECAT_PRODUCT_MONTHLY, REVENUECAT_PRODUCT_ANNUAL } = require('../src/services/purchases');
...
function checkProEntitlement(customerInfo) {
...
console.log('✓ RevenueCat entitlement verification passed');

// 3. Demo Dataset & Waypoint Integrity
const { DEMO_JOURNEYS, DEMO_EVIDENCE, DEMO_MILESTONES, DEMO_PROOF_STORY } = require('../src/services/demoData');
